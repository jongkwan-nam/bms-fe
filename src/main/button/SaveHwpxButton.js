 ...
 * PC저장(배포용)
 */
export default class SaveHwpxButton extends HTMLButtonElement {
  constructor() {
    super();
  }
  ...
  connectedCallback() {
    //
    this.innerText = GWWEBMessage.cmsg_103 + '(hwpx)';
...
customElements.define('savehwpx-button', SaveHwpxButton, { extends: 'button' });
